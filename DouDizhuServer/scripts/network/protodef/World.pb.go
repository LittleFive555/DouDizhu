...
type PEnterWorldResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	WorldState    *PWorldState           `protobuf:"bytes,1,opt,name=worldState,proto3" json:"worldState,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_World_proto_rawDesc = "" +
	...
	"\aworldId\x18\x01 \x01(\tR\aworldId\"L\n" +
	"\x13PEnterWorldResponse\x125\n" +
	"\n" +
	"worldState\x18\x01 \x01(\v2\x15.DouDizhu.PWorldStateR\n" +
	"worldState\"x\n" +
...
var file_World_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_World_proto_goTypes = []any{
	...
	(*PCharacterMove)(nil),      // 6: DouDizhu.PCharacterMove
	nil,                         // 7: DouDizhu.PWorldState.CharactersEntry
}
var file_World_proto_depIdxs = []int32{
	...
	7, // 2: DouDizhu.PWorldState.characters:type_name -> DouDizhu.PWorldState.CharactersEntry
