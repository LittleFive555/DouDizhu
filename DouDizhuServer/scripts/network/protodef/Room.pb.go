...
type PRoom struct {
	...
	// 进入世界后才有的信息
	CurrentWorld  *PWorldState `protobuf:"bytes,7,opt,name=currentWorld,proto3" json:"currentWorld,omitempty"`
...
func (x *PRoom) GetCurrentWorld() *PWorldState {
	if x != nil {
		return x.CurrentWorld
	}
	return nil
}
...
func (x *PCreateRoomResponse) GetCharacterId() string {
	if x != nil {
...
func (x *PEnterRoomResponse) GetCharacterId() string {
	if x != nil {
		return x.CharacterId
	}
	return ""
...
const file_Room_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"Room.proto\x12\bDouDizhu\x1a\fPlayer.proto\x1a\vWorld.proto\"\x81\x02\n" +
	"\x05PRoom\x12\x0e\n" +
	...
	"\x05state\x18\x06 \x01(\x0e2\x14.DouDizhu.PRoomStateR\x05state\x129\n" +
	"\fcurrentWorld\x18\a \x01(\v2\x15.DouDizhu.PWorldStateR\fcurrentWorld\"0\n" +
	"\x12PCreateRoomRequest\x12\x1a\n" +
	"\broomName\x18\x01 \x01(\tR\broomName\"\\\n" +
	"\x13PCreateRoomResponse\x12#\n" +
	"\x04room\x18\x01 \x01(\v2\x0f.DouDizhu.PRoomR\x04room\x12 \n" +
	"\vcharacterId\x18\x02 \x01(\tR\vcharacterId\"+\n" +
	"\x11PEnterRoomRequest\x12\x16\n" +
	"\x06roomId\x18\x01 \x01(\rR\x06roomId\"[\n" +
	"\x12PEnterRoomResponse\x12#\n" +
	"\x04room\x18\x01 \x01(\v2\x0f.DouDizhu.PRoomR\x04room\x12 \n" +
	"\vcharacterId\x18\x02 \x01(\tR\vcharacterId\"\x13\n" +
...
var file_Room_proto_goTypes = []any{
	...
	(*PWorldState)(nil),                // 14: DouDizhu.PWorldState
}
var file_Room_proto_depIdxs = []int32{
	...
	14, // 2: DouDizhu.PRoom.currentWorld:type_name -> DouDizhu.PWorldState
